//
//  KHContentLoadingErrorCellFactory.m
...
@implementation KHContentLoadingErrorCellFactory
...
- (UITableViewCell<KHCellProtocol> *)cellAtIndexPath:(NSIndexPath *)indexPath tableView:(UITableView *)tableView model:(id<KHTableViewModel>)model {
    UITableViewCell<KHCellProtocol> *cell = [self _getReusableCellWithClass:[KHLoadingContentErrorTableViewCell class] tableView:tableView];
    return cell;
}
